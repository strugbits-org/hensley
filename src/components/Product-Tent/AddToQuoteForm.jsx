...
export const AddToQuoteForm = ({ title, productData, matchedProducts }) => {
    ...
    return (
        <>
            <div className='w-full lg:max-w-[640px] 3xl:max-w-[1400px] sm:max-w-[400px] h-full overflow-y-scroll hide-scrollbar lg:pb-[28vh]'>
            ...
            <AddToCartButton
                ...
                classes={'lg:absolute lg:bottom-0 lg:left-0 lg:right-0 lg:z-10 lg:!h-[200px] 3xl:!h-[280px] lg:!mt-0'}
