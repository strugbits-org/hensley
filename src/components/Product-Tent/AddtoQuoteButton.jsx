...
export const AddToQuote = ({ text, classes, handleClick, type = 'button', disabled = false }) => {
    return (
        ...
        <button onClick={handleClick} disabled={disabled} type={type} className={`lg:w-full lg:h-[150px] lg:mt-[60px] sm:mt-[40px] mt-[33px] w-full h-[90px] sm:w-[492px] sm:my-[33px] bg-primary tracking-[6px] group hover:tracking-[10px] transform transition-all duration-300 hover:bg-secondary-alt hover:text-primary relative ${classes}`}>
            <span
                className='
