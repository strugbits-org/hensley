    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='w-full grid lg:grid-cols-4 grid-cols-2 justify-between gap-x-[24px] gap-y-[24px] mt-[20px]'>
                <span className='lg:col-span-4 col-span-2 uppercase font-recklessRegular text-[16px] leading-[16px] text-secondary-alt'>Please fill the bellow RFP form & A tenting Specialist will provide a custom quote</span>

                <div className='lg:col-span-4 col-span-2'>
                    <label className="block text-[12px] leading-[12px] font-haasBold uppercase font-medium text-secondary-alt mb-2">Event Name</label>
                    <input
                        type="text"
                        {...register('eventName')}
                        value={formData.eventName}
                        onChange={(e) => handleInputChange('eventName', e.target.value)}
                        className={`w-full border-b font-haasLight border-secondary-alt px-4 py-2 bg-white rounded-sm focus:outline-none shadow-sm bg-primary-alt text-secondary-alt placeholder-secondary ${errors.eventName ? 'border-b-red-500' : ''}`}
                ...
                <div className='lg:col-span-2'>
                    <label className="block text-[12px] leading-[12px] font-haasBold uppercase font-medium text-secondary-alt mb-2">Event Date</label>
                    <input
                        id="eventDateInline"
                        type="text"
                        {...register('eventDate')}
                        ...
                        className={`datepicker w-full border-b font-haasLight border-secondary-alt px-4 py-2 bg-white rounded-sm focus:outline-none shadow-sm bg-primary-alt text-secondary-alt placeholder-secondary ${errors.eventDate ? 'border-b-red-500' : ''}`}
                ...
                <div className='lg:col-span-2'>
                    <label className="block text-[12px] leading-[12px] font-haasBold uppercase font-medium text-secondary-alt mb-2">Removal Date</label>
                    <input
                        id="removalDateInline"
                        type="text"
                        ...
                        className={`datepicker w-full border-b font-haasLight border-secondary-alt px-4 py-2 bg-white rounded-sm focus:outline-none shadow-sm bg-primary-alt text-secondary-alt placeholder-secondary ${errors.removalDate ? 'border-b-red-500' : ''}`}
                        placeholder="MM/DD/YYYY"
                        readOnly
                        disabled={isSubmitting}
                    />
                ...
                <div className='lg:col-span-4 col-span-2'>
                    <label className="block text-[12px] leading-[12px] font-haasBold uppercase font-medium text-secondary-alt mb-2">tent size (if known)</label>
                    <input
                        type="text"
                        {...register('tentSize')}
                        value={formData.tentSize}
                        onChange={(e) => handleInputChange('tentSize', e.target.value)}
                        className="datepicker w-full border-b font-haasLight border-secondary-alt px-4 py-2 bg-white rounded-sm focus:outline-none shadow-sm bg-primary-alt text-secondary-alt placeholder-secondary"
                        disabled={isSubmitting}
                    />
                </div>
                ...
                <div className='lg:col-span-2'>
                    <label className="block text-[12px] leading-[12px] font-haasBold uppercase font-medium text-secondary-alt mb-2">NUMBER OF GUESTS*</label>
                    <input
                        type="text"
                        {...register('numberOfGuests')}
                        value={formData.numberOfGuests}
                        onChange={(e) => handleInputChange('numberOfGuests', e.target.value)}
                        className={`w-full border-b font-haasLight border-secondary-alt px-4 py-2 bg-white rounded-sm focus:outline-none shadow-sm bg-primary-alt text-secondary-alt placeholder-secondary ${errors.numberOfGuests ? 'border-b-red-500' : ''}`}
                        disabled={isSubmitting}
                    />
                ...
                <div className='lg:col-span-4 col-span-2'>
                    <label className="block text-[12px] leading-[12px] font-haasBold uppercase font-medium text-secondary-alt mb-2">CARPET / ASTROTURF COLOR</label>
                    <input
                        type="text"
                        {...register('carpetColor')}
                        value={formData.carpetColor}
                        onChange={(e) => handleInputChange('carpetColor', e.target.value)}
                        className="w-full border-b font-haasLight border-secondary-alt px-4 py-2 bg-white rounded-sm focus:outline-none shadow-sm bg-primary-alt text-secondary-alt placeholder-secondary"
                        disabled={isSubmitting}
                    />
                </div>

                <div className='lg:col-span-4 col-span-2'>
                    <label className="block text-[12px] leading-[12px] font-haasBold uppercase font-medium text-secondary-alt mb-2">TENT SIZE</label>
                    <input
                        type="text"
                        value={formData.tentSize}
                        onChange={(e) => handleInputChange('tentSize', e.target.value)}
                ...
                <div className='lg:col-span-4 col-span-2'>
                    <label className="block text-[12px] leading-[12px] font-haasBold uppercase font-medium text-secondary-alt mb-2">DISTANCE FROM TRUCK TO SITE</label>
                    <input
                        type="text"
                ...
                <div className='lg:col-span-4 col-span-2'>
                    <label className="block text-[12px] leading-[12px] font-haasBold uppercase font-medium text-secondary-alt mb-2">PLEASE PROVIDE ANY OTHER ADDICIONAL INFO</label>
                    <textarea
            ...
            <div className='absolute bottom-0 right-0 w-full sm:w-[55%] p-5 bg-primary-alt border-none'>
                <AddToCartButtonInline onClick={handleSubmit(onSubmit)} classes={'h-[75px] lg:mt-4 mt-0'} text={isSubmitting ? "Please wait..." : "add to quote"} disabled={isSubmitting} showArrow={true} />
            </div>
        </div>
    );
};