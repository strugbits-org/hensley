...
export default function ProductSlider({ product }) {
  ...
  return (
    <>
      ...
      <div
        className={`lg:flex hidden w-full max-w-[794px] 3xl:max-w-[1700px] h-[795px] lg:h-full gap-x-[24px] 3xl:gap-x-[40px] justify-between transition-opacity duration-300 ${!isSliderReady ? 'invisible opacity-0' : 'visible opacity-100'
          }`}
      >
        {/* Main Slider */}
        <div
          ref={sliderRef}
          className="keen-slider !w-[calc(100%-144px)] 3xl:!w-[calc(100%-220px)] h-[795px] lg:h-full p-[1px]"
          role="region"
        ...
        <div
          ref={thumbnailRef}
          className="keen-slider !w-[120px] 3xl:!w-[180px] shrink-0 h-[795px] lg:h-full thumbnail grid grid-cols-1 overflow-hidden p-[1px]"
          role="region"
