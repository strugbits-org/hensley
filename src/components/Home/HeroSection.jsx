...
export const HeroSection = () => {
    ...
    return (
        <div className="relative h-screen isolate px-6 pt-44 lg:px-8 flex items-center">
            ...
            <div className="mx-auto lg:max-w-[90rem] text-center font-haasRegular">
                ...
                <h1 className="mt-28 text-[2.4rem] lg:text-[6rem] 2xl:text-[7.5rem] text-primary-alt font-recklessLight leading-[0.9]">
