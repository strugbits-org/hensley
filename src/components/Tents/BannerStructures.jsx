            ...
            <div className='lg:px-[10px] lg:max-w-[1557px] sm:max-w-[490px] lg:mt-[197px]  w-full flex flex-col justify-center items-center'>
                ...
                <div className='w-full py-[16px] flex lg:flex-row flex-col lg:border-b border-t border-white'>
                    <div className='lg:w-1/2 flex flex-col gap-y-[24px] lg:mb-0 mb-[16px]'>
                        <span className='text-[16px] leading-[20px] text-white font-haasRegular uppercase block'>
                    ...
                    <div className='lg:w-1/2 lg:border-none border-t lg:pt-0 pt-[16px]'>
                        ...
                        <ul>
                            <li className='text-[16px] leading-[20px] text-white font-haasRegular uppercase'>Heavy rig loads</li>
                            <li className='text-[16px] leading-[20px] text-white font-haasRegular uppercase'>No scissor cables</li>
                            <li className='text-[16px] leading-[20px] text-white font-haasRegular uppercase'>Multiple ballast types</li>
                            <li className='text-[16px] leading-[20px] text-white font-haasRegular uppercase'>No wallpole angle brace</li>
                        </ul>
                    </div>
                </div>
                <div className='lg:self-end lg:border-none sm:border-t border-white lg:py-0 py-[16px] lg:mt-[211px] lg:max-w-[292px] w-full lg:gap-y-[110px] gap-y-[16px] flex flex-col'>
                    <button className='border border-white h-[45px] lg:w-[292px] w-full text-white uppercase text-[12px] font-haasRegular'>
                        see gallery
                    </button>
                    <div>
                         <span className='text-[16px] leading-[20px] text-white font-haasRegular uppercase block'>
