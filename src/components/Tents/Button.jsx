...
w-full
        ...
        group-hover:font-haasBold
            ...
            <svg
                ...
                className={`${iconTrue ? "lg:block":"lg:hidden"} block ml-2 transition-all duration-300 stroke-[#2c2216] group-hover:stroke-primary absolute right-[5%] top-1/2 -translate-y-1/2`}
            >
