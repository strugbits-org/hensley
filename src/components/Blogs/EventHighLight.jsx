        ...
        <div className='w-full group'>
            ...
            <div onClick={handleRedirection} className='w-full border border-primary-border p-[24px] gap-x-[24px] flex lg:flex-row flex-col cursor-pointer'>
                <div className='lg:w-3/5 overflow-hidden'>
                    <PrimaryImage url={blogRef.coverImage} size="tablet" alt={blogRef.title} customClasses="h-full w-full max-h-[600px] object-cover transition-transform duration-300 group-hover:scale-105" />
                </div>
