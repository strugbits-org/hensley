           ...
           bg-white
            ...
            <div className='w-full '>
                ...
                <div className='sm:hidden flex-col '>
                    <span className='block sm:text-[16px] text-[20px] text-secondary-alt font-haasRegular uppercase lg:mt-[21px] sm:mb-[27px]'>romana collection</span>
