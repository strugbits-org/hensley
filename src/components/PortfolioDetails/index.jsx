...
const PortfolioDetails = ({ data }) => {
    ...
    return (
        <>
            ...
            <FeaturedProducts classes={'z-10'} data={storeProducts} pageDetails={{ featuredProjectTitle: featuredProductTitle || "Products featured in this PROJECT entry:" }} loop={false} origin="auto" />
