...
import SecondryProductCard from '../common/SecondryProductCard'
    ...
    return (
        <div className='px-[24px] w-full h-full'>
            ...
            <div className='w-full h-full grid grid-cols-6 max-2xl:grid-cols-4 max-lg:grid-cols-3 max-md:grid-cols-2 gap-x-[24px] gap-y-[20px]'>
                <SecondryProductCard data={{ product: { name: "POLTRONA MONTANA", mainMedia: image } }} onAddToCart={() => { console.log("Hello World") }} />
                <SecondryProductCard data={{ product: { name: "POLTRONA MONTANA", mainMedia: image } }} onAddToCart={() => { console.log("Hello World") }} />
                <SecondryProductCard data={{ product: { name: "POLTRONA MONTANA", mainMedia: image } }} onAddToCart={() => { console.log("Hello World") }} />
                <SecondryProductCard data={{ product: { name: "POLTRONA MONTANA", mainMedia: image } }} onAddToCart={() => { console.log("Hello World") }} />
                <SecondryProductCard data={{ product: { name: "POLTRONA MONTANA", mainMedia: image } }} onAddToCart={() => { console.log("Hello World") }} />
