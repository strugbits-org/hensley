        ...
        <div className="bg-secondary-glass p-6 md:p-12 lg:p-16 flex flex-col justify-center mb-10">
          <div className="lg:max-w-[600px] lg:text-left text-center ml-auto mr-0">
            ...
            <CustomLink to={buttonLink}>
              <PrimaryButton className="lg:mt-[35px] border border-secondary-alt text-secondary-alt hover:text-secondary-alt hover:border-secondary-alt text-base hover:bg-primary max-h-[60px] max-w-[280px] px-8 py-4 hover:[letter-spacing:4px]">
                {buttonLabel}
              </PrimaryButton>
            </CustomLink>
          </div>
        ...
        <div className="grid grid-cols-1 lg:py-[25px] lg:grid-cols-2 lg:border border-primary-alt items-center">
          ...
          <div className="md:p-12 lg:pl-16 flex flex-col justify-center">
            {convertToHTML({
              content: bodyContent,
              class_heading:
                "text-secondary-alt text-[24px] lg:text-[35px] lg:leading-[35px] tracking-tight font-recklessRegular mb-4",
              class_p:
                "text-secondary-alt leading-[20px] text-sm lg:text-base font-haasRegular mb-3",
            })}
          </div>
        </div>
      </div>
