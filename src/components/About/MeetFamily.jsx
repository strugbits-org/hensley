...
//         <Image src={logo} />
//         <p
//           className="max-w-[417px] text-center text-[#FFFFFF] font-haasRegular
//                  md:text-[18px]
//                  leading-[30px]
//                   sm:text-[14px]
//                 sm:leading-[18px]
//                   mt-[61px]"
//         >
//           VIDENT EXHIBITS IS OUR IN-HOUSE EXHIBIT STUDIO. SPECIALIZING IN THE
//           DESIGN AND PRODUCTION OF CORPORATE EXHIBIT ENVIRONMENTS
//         </p>
//         <p
//           className="max-w-[417px] text-center text-[#FFFFFF] font-haasRegular
//                 md:text-[18px]
...
//                 mt-11 mb-[48px]"
//         >
//           VIDENT COMBINES CUTTING-EDGE TECHNOLOGY, INGENUITY, AND CRAFTSMANSHIP
//           TO MANUFACTURE CREATIVE, QUALITY TRADE SHOW DISPLAYS, EXHIBITS AND
//           EMPOWERING ACTIVATIONS THAT ENABLE EXHIBITORS TO ENGAGE THEIR
//           CUSTOMERS IN THE MOST INNOVATIVE WAYS.
//         </p>
...
//       <div className="w-full grid grid-cols-1 lg:grid-cols-3 lg:gap-10 lg:px-8 px-2 pt-10 pb-10 gap-0">
//         <Cards />
//         <Cards />
//         <Cards />
//       </div>
