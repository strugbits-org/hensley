...
function ProductCard2({data}) {
  return (
          <div className="w-full px-[10px] grid sm:grid-cols-2 grid-cols-1 lg:gap-4 lg:py-[24px] sm:gap-y-[12px] sm:gap-x-[12px] gap-y-[30px] lg:mt-0 mt-[12px]">
                ...
                <div className="lg:w-1/2 flex flex-col justify-between lg:px-[24px] lg:py-[24px]">
                  ...
                  <div className="hidden lg:block">
                    <Image
                      src={arrowIcon}
                      alt="Arrow"
                      className="arrow w-[25px] h-[25px] transition-all duration-300 ease-in-out group-hover:w-[133px] group-hover:h-[133px] lg:mb-[12px]"
                    />
