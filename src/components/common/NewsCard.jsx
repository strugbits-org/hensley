...
function NewsCard({ data }) {
    ...
    return (
        <div className="relative group border border-primary-border">
            <PrimaryImage alt={title} url={coverImage} customClasses={"h-full w-full object-cover h-[528px]"} />
                ...
                <div className='w-full flex gap-1'>
                    ...
                    <div className='w-1/3 flex justify-end'>
                        <PrimaryImage
                            ...
                            alt="Arrow"
                            customClasses="h-[20px] group-hover:lg:h-full object-contain transition-all duration-300 ease-in-out"
                        />
                    </div>
                </div>
            </div>
