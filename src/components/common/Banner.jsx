...
export const Banner = ({ data }) => {
    ...
    return (
        <div className='relative banner max-lg:h-screen lg:p-6 sm:mt-[100px] border border-primary-border'>
            <PrimaryImage timeout={0} url={backgroundImage} alt={title} customClasses="border border-primary-border h-full w-full" />
