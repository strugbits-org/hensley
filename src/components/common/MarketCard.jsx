...
export const MarketCard = ({ data }) => {
    ...
    return (
        <CustomLink to={`/market${data.slug}`} className='relative group w-full lg:w-1/3 border border-primary-border min-h-[608px] overflow-hidden'>
            ...
            <div className='flex items-end absolute inset-6 p-4'>
                ...
                <h2 className="ml-4 lg:ml-12 xl:ml-16 text-[28px] lg:text-[30px] xl:text-[45px] lg:leading-[42px] xl:leading-[70px] tracking-[-0.30px] font-recklessRegular text-primary-alt uppercase text-center w-full">
                    {title}
                </h2>
            </div>
        </CustomLink>
