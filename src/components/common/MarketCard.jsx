...
export const MarketCard = ({ data, size }) => {
    ...
    return (
        <CustomLink to={`/market${data.slug}`} className={`relative group w-full border border-secondary min-h-[382px] lg:min-h-[608px] overflow-hidden ${size === "large" ? "lg:w-1/2" : "lg:w-1/3"}`}>
