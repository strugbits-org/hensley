...
function cartSlider() {
  ...
  return (
      ...
      {data.map((dt, index) => {
        ...
        return (
          ...
          >
            ...
            <div>
            <h3 className="text-[#2C2216] w-[313px] text-[70px] font-recklessLight leading-[60px] mt-[20px] mb-[20px]">
        {dt.heading}
      </h3>
            {isActive ? (
    <>
    ...
    <p className="text-[#2C2216] text-[16px] font-haasRegular w-[600px] leading-[20px]">+SEE MORE</p>
  )}
            </div>
