...
const JobBoard = () => {
  return (
    <>
    <div className='min-h-screen w-full border py-[20px] flex justify-center items-center px-[20px]'>
      <div className='lg:w-[1557px] sm:w-full'>
        ...
        {jobs.map((job, index) => (
          <div key={index} className='w-full grid 
            ...
            <div className='grid 
              ...
              <span className='lg:text-[24px] sm:text-[14px] leading-[1.1] font-haasLight text-secondary-alt uppercase'>{job.type}</span>
       ...
       pt-[129px] pb-[113px]
       '>
                  <SectionTitle text={"Explore available Positions"} classes={"lg:!text-[140px] lg:!leading-[140px] sm:!text-[55px] sm:!leading-[50px] !leading-[35px] border-none"} />
